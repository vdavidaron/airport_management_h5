...
/**
 * This is the item provider adapter for a {@link airport.Flight} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FlightItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addFlightNumberPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Flight Number feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFlightNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Flight_flightNumber_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Flight_flightNumber_feature", "_UI_Flight_type"),
				 AirportPackage.Literals.FLIGHT__FLIGHT_NUMBER,
				 true,
				 false,
				 false,
	...
	protected void addTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Flight_time_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Flight_time_feature", "_UI_Flight_type"),
				 AirportPackage.Literals.FLIGHT__TIME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Flight_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Flight_type_feature", "_UI_Flight_type"),
				 AirportPackage.Literals.FLIGHT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addCityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Flight_city_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Flight_city_feature", "_UI_Flight_type"),
				 AirportPackage.Literals.FLIGHT__CITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
