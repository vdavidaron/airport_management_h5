 ...
 * </p>
 * <ul>
 *   <li>{@link airport.impl.BaggageClaimImpl#getName <em>Name</em>}</li>
 *   <li>{@link airport.impl.BaggageClaimImpl#getBelts <em>Belts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BaggageClaimImpl extends AreaImpl implements BaggageClaim {
	...
	protected EClass eStaticClass() {
		return AirportPackage.Literals.BAGGAGE_CLAIM;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AirportPackage.BAGGAGE_CLAIM__NAME, oldName, name));
	}
	...
	public EList<Belt> getBelts() {
		if (belts == null) {
			belts = new EObjectContainmentEList<Belt>(Belt.class, this, AirportPackage.BAGGAGE_CLAIM__BELTS);
		}
		return belts;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == namedElement.class) {
			switch (derivedFeatureID) {
				case AirportPackage.BAGGAGE_CLAIM__NAME: return AirportPackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == namedElement.class) {
			switch (baseFeatureID) {
				case AirportPackage.NAMED_ELEMENT__NAME: return AirportPackage.BAGGAGE_CLAIM__NAME;
				default: return -1;
			}
		}
